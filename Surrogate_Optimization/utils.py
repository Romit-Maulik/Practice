...
def plot_scatter(true,predicted,fname):
    ...
    plt.xlabel('True_'+fname)
    plt.xlabel('Predicted_'+fname)
    plt.legend()
...
if __name__ == '__main__':
    ...
    # t_dnn = np.asarray([0.08876, 0.33146928, 0.5724823, 0.15938265,-0.1648, -0.61616158, -0.53778743,  0.04067]) # 40-20
    ...
    t_dnn_lift = np.asarray([0.08876, 0.3269, 0.75842, 0.20406465, -0.1648, -0.64436213, -0.56695343, 0.05696154])
