...
using std::endl;
 ...
 /* Main program */
 int main (int argc, const char * argv[]) // argv is a pointer to argument array first element. This array contains argument characters
 {
    
    //
    cout << "No. arguments: " << argc << endl;
    cout << "Which are: " << endl;
