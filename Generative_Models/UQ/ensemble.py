...
class ensemble_model(Model):
    def __init__(self,data_tuple,lrate=0.001,num_epochs=1000):
        ...
        self.eps_range = 0.01*(np.max(data_tuple[0][:,0])-np.min(data_tuple[0][:,0]))
    ...
    def model_inference(self):
        ...
        np.save('Single_Ensemble_mean.npy',mean)
        np.save('Single_Ensemble_var.npy',var)
        
        return None


if __name__ == '__main__':
    print('One model of deep ensembles architecture')