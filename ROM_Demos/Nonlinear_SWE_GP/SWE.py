...
from parameters import fvm_solve, num_samples, num_train, num_steps_per_plot
from pyDOE import *
...
if __name__ == '__main__':
    if fvm_solve:
        ...
        np.save('snapshot_matrix_pod.npy',snapshot_matrix_pod[:,:(num_train*num_steps_per_plot)])
        np.save('snapshot_matrix_test.npy',snapshot_matrix_pod[:,(num_train*num_steps_per_plot):])
