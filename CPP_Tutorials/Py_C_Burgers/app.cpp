...
int main(int argc, char *argv[])
{
    ...
    std::cout << "Initial resource usage:" << usage_info.ru_maxrss << std::endl;
    ...
    getrusage(0,&usage_info);
    std::cout << "Resource usage after Python initialize:" << usage_info.ru_maxrss << std::endl;
    ...
    do{
      ...
      getrusage(0,&usage_info);
      std::cout << "Resource usage after timestep:" << usage_info.ru_maxrss << std::endl;
    }while(t<FT);
    ...
    getrusage(0,&usage_info);
    std::cout << "Resource usage after analysis:" << usage_info.ru_maxrss << std::endl;
